		...
		services: {
					...
					"config": {
						"groups": [{
							"tiles": [{
								...
								"properties": {
									"title": "Delta app",
									"targetURL": "#deltanmspdeltaapp-display"
								}
							}]
						}]
					}
			...
			"ClientSideTargetResolution": {
				"adapter": {
					"config": {
						"inbounds": {
							"deltanmspdeltaapp-display": {
								"semanticObject": "deltanmspdeltaapp",
								"action": "display",
								...
								"resolutionResult": {
									...
									"additionalInformation": "SAPUI5.Component=deltanmsp.deltaapp",
									"url": sap.ui.require.toUrl("deltanmsp/deltaapp")
								}
							}
						}
					}
