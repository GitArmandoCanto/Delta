sap.ui.define([
    ...
    function (Controller, MessageBox) {
        ...
        return Controller.extend("deltanmsp.deltaapp.controller.View1", {
            ...
            onInit: function () {
                ...
                this.getView("View1").byId("lbl_hddate").setText(today);
                                                                ...
                                                                if (!(typeof oModel === "undefined") || !(typeof oModel === "null")) {
                                                                    ...
                                                                    oModel.read("/ZWCM_MC_WRDTSet", {
                                                                        ...
                                                                        success: function (oData, oResponse) {
                                                                            ...
                                                                            var obj = "";
                                                                            //var Ctrller = sap.ui.getCore().byId("View1").getController();
                                                                            // create JSON model
                                                                        ...
                                                                        //#region SETDATA
                                                                            ...
                                                                            model.setProperty("/val_bapp_on", todayOn);
            ...
            onSubmit: function (evt) {
                var submitdata = this.getView("View1").getModel().getData();
                var oview = this.getView("View1");
                var oThat = this;
                MessageBox.confirm("Are you ready to submit?", {
                    ...
                    onClose: async function (sAction) {
                        if (sAction === "OK") {
                            var sserviceurl = "/sap/opu/odata/sap/ZODATA_MC_WRDT_C_SRV";
                            var oModel = new sap.ui.model.odata.ODataModel(sserviceurl, true);
                            //var submitJson = this.getView("View1").getModel().getData();
                            var submitJson = this.submitJson;
                            //var oViewRmrk = this.getView("View1");
